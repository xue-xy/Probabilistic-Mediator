...
public class UtilClass {
	...
	/**
	 * get all implemention classes of <b>_interface</b> in the root package, i.e.
	 * the whole directory in classloader
	 * 
	 * @param _interface
	 * @return
	 */
	...
	public static List<Class> getImplementation(Class _interface, String pkgname) {
		...
		Path searchPath = Paths.get(getClassRoot(), pkgname.replace(".", "/"));
