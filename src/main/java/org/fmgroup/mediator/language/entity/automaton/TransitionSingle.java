...
public class TransitionSingle implements Transition, Statements {
    ...
    public TransitionSingle fromContext(ParserRuleContext context, RawElement parent) throws ValidationException {
        ...
        org.antlr.v4.runtime.tree.TerminalNode node = ((MediatorLangParser.TransitionSingleContext) context).REAL();
        if(node != null) {
        	setProb(Double.valueOf(node.getText()));
        }
    ...
    public String toString() {
        String rel = guard.toString() + " -> " + "[" +probility + "]";
    ...
    public TransitionSingle setProb(double prob) {
    	this.probility = prob;
    	return this;
    }
