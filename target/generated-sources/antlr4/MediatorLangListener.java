...
public interface MediatorLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ProbtransitionSingle}
	 * labeled alternative in {@link MediatorLangParser#transition}.
	 * @param ctx the parse tree
	 */
	void enterProbtransitionSingle(MediatorLangParser.ProbtransitionSingleContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ProbtransitionSingle}
	 * labeled alternative in {@link MediatorLangParser#transition}.
	 * @param ctx the parse tree
	 */
	void exitProbtransitionSingle(MediatorLangParser.ProbtransitionSingleContext ctx);
	/**
